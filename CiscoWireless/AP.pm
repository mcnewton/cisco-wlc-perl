...
# CISCO-LWAPP-AP::CLApEntry
    ...
    "powerstatus"                   => [ ".1.3.6.1.4.1.9.9.513.1.1.1.1.20.", 0, 0, INTEGER ],
    "enabletelnet"                  => [ ".1.3.6.1.4.1.9.9.513.1.1.1.1.21.", 0, 1, INTEGER ],
    "enablessh"                     => [ ".1.3.6.1.4.1.9.9.513.1.1.1.1.22.", 0, 1, INTEGER ],
